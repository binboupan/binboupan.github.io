...
>**<font size=4><span style="color: yellow">⚠</span>&nbsp;&nbsp;&nbsp;<span style="color:red">Guide updated on 24th of June 2025. Updated vbmeta flashing information and some links. I've had far too many requests for device ROM dumps so PLEASE create a backup first.</span></font>**
...
- [FakeGApps](https://github.com/whew-inc/FakeGApps/releases/tag/6.6)
- [Aurora Store (If you don't use Google Play Store)](https://auroraoss.com/files)
...
Copy boot_a.bin from **your backup** to the same folder. Run the following commands:
